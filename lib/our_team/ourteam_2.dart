...
class Ourteam2 extends StatelessWidget {
  const Ourteam2({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Image.asset("images/Aliyan.png", height:448, width:264,),
                  ),
                  SizedBox(height: 20,),
                  Padding(
                  ...
                  Text('Aliyan Shahid Satti',style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700,color: Color(0xFF463263)),),
                  SizedBox(height: 15,),
                  Padding(
